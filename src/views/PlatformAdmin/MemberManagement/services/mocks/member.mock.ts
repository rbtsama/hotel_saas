...
export const mockMemberQueryRecords: MemberQueryRecord[] = [
  {
    ...
    currentLevel: 3,
    formalLevel: 3,
    formalExpiryDate: '2026-10-15',
    obtainMethod: 'nights_consume',
    relatedMerchant: 'XX酒店',
    giftLevel: 0,
    giftExpiryDate: '-',
    giftFrom: '-',
  ...
  },
  {
    ...
    currentLevel: 3,
    formalLevel: 2,
    formalExpiryDate: '2026-08-20',
    obtainMethod: 'merchant_import',
    relatedMerchant: 'YY酒店',
    giftLevel: 3,
    giftExpiryDate: '2025-12-05',
    giftFrom: '18512341234',
    updatedAt: '2025-11-19 14:20:00',
  },
  {
    id: 'member-3',
    phone: '13634569012',
    ...
    currentLevel: 1,
    formalLevel: 1,
    formalExpiryDate: '2026-01-25',
    obtainMethod: 'nights_consume',
    relatedMerchant: 'ZZ酒店',
    giftLevel: 0,
    giftExpiryDate: '-',
    giftFrom: '-',
    updatedAt: '2025-11-18 09:15:00',
  },
  {
    id: 'member-4',
    phone: '13745670123',
    ...
    obtainMethod: 'merchant_import',
    relatedMerchant: 'AA酒店',
    giftLevel: 2,
    giftExpiryDate: '2025-12-01',
    giftFrom: '18623456789',
  ...
  },
  {
    ...
    obtainMethod: 'nights_consume',
    relatedMerchant: 'BB酒店',
    giftLevel: 2,
    giftExpiryDate: '2025-12-10',
    giftFrom: '18734567890',
