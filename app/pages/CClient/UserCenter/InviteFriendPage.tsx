  ...
  return (
    <MobileFrame navTitle="邀请好友得积分" showTabBar={true}>
      <div className="p-4 space-y-4">
        {/* 邀请奖励说明 */}
        <div className="bg-gradient-to-br from-secondary to-amber-500 rounded-2xl p-6 text-white text-center">
        ...
        <div className="bg-white rounded-xl p-4 border border-slate-200">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              ...
              <p className="text-xl font-bold text-primary">3人</p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg border border-green-200">
              ...
              <div className="text-right">
                <p className="text-sm font-semibold text-green-600">+30积分</p>
              </div>
            </div>
          ...
          <div className="mt-4 pt-4 border-t border-slate-200 text-center">
            <p className="text-sm text-slate-600">
              已获得积分：<span className="font-semibold text-secondary">90</span>
            </p>
          </div>
        </div>
